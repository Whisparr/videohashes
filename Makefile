...
windows-386:
	GOOS=windows GOARCH=386 EXTRA_LDFLAGS='-extldflags=-static -s -w' \
		go build -o dist/windows-386/videohashes.exe ./cmd/videohashes
...
linux-386:
	GOOS=linux GOARCH=386 EXTRA_LDFLAGS='-extldflags=-static -s -w' \
		go build -o dist/linux-386/videohashes ./cmd/videohashes
...
freebsd-amd64:
	GOOS=freebsd GOARCH=amd64 EXTRA_LDFLAGS='-extldflags=-static -s -w' \
		go build -o dist/freebsd-amd64/videohashes ./cmd/videohashes


build: windows-amd64 windows-386 linux-amd64 linux-386 macos-amd64 windows-arm64 linux-arm64 macos-arm64 windows-arm linux-arm freebsd-amd64
